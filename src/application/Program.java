...
public class Program {
	...
	public static void main(String[] args) throws ParseException {
		...
		String mountAndYear = sc.next();
		int mounth = Integer.parseInt(mountAndYear.substring(0,2));
		...
		System.out.println("Income for " + mountAndYear + ": " + String.format("%.2f",worker.income(year, mounth)));
